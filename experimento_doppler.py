...
# 1. Carregar Base Vencedora (Relatividade)
...
# 2. Cálculo da Aceleração (Derivada da Velocidade)
df_15m['acceleration'] = df_15m['velocity'].diff()

# 3. Barreira Adaptativa (Mantendo a vitória do Exp 08)
